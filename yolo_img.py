...
def yolo_detect(pathIn,
    ...
    for i in net.getUnconnectedOutLayers():
        print(i)
    ln2 = [ln[i - 1] for i in net.getUnconnectedOutLayers()]
    ...
    if pathOut is None:
        ...
        cv2.imwrite('output', img, [int(cv2.IMWRITE_JPEG_QUALITY), jpg_quality])
    print(img.shape)
    cv2.waitKey(0)
    cv2.destroyAllWindows()
    return 'with_box_' + base_path
